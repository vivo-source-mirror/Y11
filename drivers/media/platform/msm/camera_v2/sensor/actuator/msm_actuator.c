...
static struct msm_actuator msm_midvcm_actuator_table;/*add for mid vcm type, vivo cxd add 20180305*/
...
static struct msm_actuator *actuators[] = {
	...
	&msm_midvcm_actuator_table,/*add for mid vcm type, vivo cxd add 20180305  */
};
	...
	struct msm_actuator_move_params_t *move_params)
{
	...
	reg_setting.data_type = a_ctrl->i2c_data_type;
	reg_setting.size = a_ctrl->i2c_tbl_index;
	/*pengzuo add for the actuator invail parameters, not operate i2c and return success.*/
	if (0 == reg_setting.size) {
		pr_err("pengzuo the reg_setting.size is null!!!\n");
		return rc;
	}
	/*add end*/
	rc = a_ctrl->i2c_client.i2c_func_tbl->i2c_write_table_w_microdelay(
...
/*add for mid vcm type, vivo cxd add  20180305*/
static struct msm_actuator msm_midvcm_actuator_table = {
	.act_type = ACTUATOR_MIDVCM,
	.func_tbl = {
		.actuator_init_step_table = msm_actuator_init_step_table,
		.actuator_move_focus = msm_actuator_move_focus,
		.actuator_write_focus = msm_actuator_write_focus,

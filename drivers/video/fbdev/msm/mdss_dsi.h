...
#define LCMID_NODE_BUFERR_COUNT 11
#define BBK_LCM_BL_ID_LEN 16
...
struct mdss_dsi_ctrl_pdata {
	...
	struct dsi_panel_cmds pre_off_cmds;
	struct dsi_panel_cmds pre_on_cmds;
	struct dsi_panel_cmds off_cmds_without_gesture;
	...
	bool phy_power_off;
	struct dsi_panel_cmds lcm_cabc_level1;
	struct dsi_panel_cmds lcm_cabc_level2;
	struct dsi_panel_cmds lcm_cabc_level3;
	struct dsi_panel_cmds lcm_cabc_off;
	struct dsi_panel_cmds lcm_cmd_backlight_dimming_enable;
	struct dsi_panel_cmds lcm_backlight_dimming_off_cmd;
	int lcm_sre_max_level;
	int vivo_sre_enable;

	struct vivo_panel_info vivo_panel_info;
};

...
enum incell_lcm_power_mode_control {
	INCELL_LCM_POWER_OFF = 0,
	INCELL_LCM_POWER_ON,
	INCELL_LCM_POWER_ON_BY_LCM,
	INCELL_LCM_POWER_ON_WITHOUT_LCM_RST,
	INCELL_LCM_TP_RST_LOW,
	INCELL_LCM_TP_RST_HIGH,
	INCELL_LCM_AVDD_AVEE_OFF,
	INCELL_LCM_AVEE_AVEE_ON
};

...
#define USBIN_AICL_PERIODIC_RERUN_EN	BIT(4)
#define USBIN_AICL_START_AT_MAX_BIT		BIT(5)
#define USBIN_AICL_SUSPEND_ON_COLLAPSE		BIT(7)
#define USBIN_AICL_ADC_EN_BIT			BIT(3)

#define USBIN_5V_AICL_THRESHOLD_REG		(USBIN_BASE + 0x81)
#define USBIN_5V_AICL_THRESHOLD_REG_MASK	GENMASK(2, 0)
...
#define SCHG_MISC_AICL_RERUN_TIME_CFG	(MISC_BASE + 0x61)
#define SCHG_MISC_AICL_RERUN_TIME_CFG_MASK		GENMASK(1, 0)

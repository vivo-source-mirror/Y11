...
#define FTS_GESTURE_POINTS_MAX_VIVO			10
...
int fts_read_reg_byte(u8 regaddr, u8 *regvalue);
int fts_write(u8 *writebuf, u32 writelen);
int fts_write_reg_byte(u8 regaddr, u8 regvalue);
...
/* test */
int focaltech_get_rawordiff_data(int which, int *data);
int bbk_ft_process_by_package(unsigned char *package_name);

...
#if WAKEUP_GESTURE
extern const uint16_t gesture_key_array_Spi[];
#endif
...
struct nvt_ts_data {
	...
	struct pinctrl_state *spi_cs_set, *pin_miso_pulllow, *pin_int_low;	
#endif
};
...
#define NVTFLASH_WORK_PROTECT (1)
	...
	extern uint8_t u8_NVTflashWorking;
#endif
...
//---extern structures---
extern struct nvt_ts_data *ts_spi;
...
extern void spi_nvt_spi_esd_check_enable(uint8_t enable);

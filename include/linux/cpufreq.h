...
/*Begin lipengkui modify add api for getting cpufreq. 2018-08-15*/
struct cpufreq_frequency_table *vivo_cpufreq_frequency_gettable(unsigned int cpu);
/*End lipengkui modify add api for getting cpufreq. 2018-08-15*/
